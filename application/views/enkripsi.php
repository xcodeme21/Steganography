                ...
                <form class="form-horizontal" method="post" action="./enkripsi/process" enctype="multipart/form-data">
									<fieldset>
										<div class="form-group">
											...
											<div class="col-lg-4">
												<input class="form-control" id="inputFile" placeholder="Input File (excel)" type="file" name="excel_file" required>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-lg-4">
												<input class="form-control" id="inputGambar" placeholder="Input Gambar" type="file" name="gambar_file" required>
											</div>
										</div>
										<div class="form-group">
